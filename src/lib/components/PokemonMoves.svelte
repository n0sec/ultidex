...
<table class="border-collapse border border-slate-500 w-full">
	<thead>
		<tr>
			...
			<th class="border border-slate-600">Move Name</th>
			<th class="border border-slate-600">Type</th>
			<th class="border border-slate-600">Power</th>
			<th class="border border-slate-600">Accuracy</th>
			<th class="border border-slate-600">PP</th>
		</tr>
	</thead>
	<tbody>
		<tr>
